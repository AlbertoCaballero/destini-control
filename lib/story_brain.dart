...
class StoryBrain {
  ...
  set storyNumber(int storyNumber) => _storyNumber = storyNumber;
  ...
  nextStory(int choice) {
    switch(storyNumber) {
      ...
      case 1:
        ...
        break;
      case 2:
        if(choice == 1) storyNumber = 5;
        else storyNumber = 4;
        break;

      default:
        if(storyNumber == 3 || storyNumber == 4 || storyNumber == 5 && choice == 1) storyNumber = 0;
        break;
    }
  }
